    ...
    <div class="container">
        ...
        if(!empty($data)){
            foreach ($data as $v) {
                ...
                $categories = \App\Categories::find($v->categories_id)->name;
        ...
        <section class="mt-4">
            ...
            <div class="row">
                ...
                <div class="col-md-8 mb-4">
                    ...
                    <img src="{{asset('documents/imagePost')}}{{'/'.$image}}" 
                        class="img-fluid" alt="">
                    </div>
                    <!--/.Featured Image-->
                    ...
                    <div class="card mb-4 wow fadeIn">
                        ...
                        <div class="card-body">
                            ...
                            <p class="h5 my-4" style="text-decoration: underline">{{$title}}</p>
                            <p class="my-4">
                                @php
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled">
                                @foreach ($morefromauthor as $mfa)
                                    ...
                                    src="{{asset('documents/imagePost')}}{{'/'.$mfa->image}}" 
                                    style="max-height: 70px; max-width: 70px;"
                                    alt="Generic placeholder image">
                                        <div class="media-body">
                                        <a href="post/{{$mfa->slug}}">
                                                <h6 class="mt-0 mb-1 font-weight-bold">{{$mfa->title}}</h6>
                                            </a>
                                        </div>
                                    </li>
                                @endforeach
            ...
            $.ajax({
                ...
                success: function (d) {
                    if(d.status){
                        ...
                        $("#parentAddContact").html('<span class="badge btn-primary" data-id="{{$user->id}}" id="addContact"><i class="far fa-comments" ></i> Add Contact</span>')
                    }
                }
            });
        }

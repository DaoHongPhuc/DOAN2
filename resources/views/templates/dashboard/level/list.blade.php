    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title m-0">List Level</h4>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title m-0" id="myLargeModalLabel">NEW LEVEL</h4>
...
<script>
    ...
    function init(){
        ...
        $('#datatable tbody').on( 'click', 'button#delete', function () {
            ...
            Swal.fire({
                title: 'Confirm',
                text: "Are you sure delete Level Name: "+data.name+" ?" ,
                icon: 'warning',
    ...
    function validateFormAdd(){
        $('#addNewForm').validate({
            ...
            messages:{
                Name : {
                  required: "Enter Name",
                  minlength: "Name must have least 2 characters",
                },
                Description: {
                  required: "Enter Description",
                  minlength: "Description must have least 10 characters"
                }
            },
